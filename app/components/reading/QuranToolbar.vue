...
<template>
  <header
    class="quran-toolbar"
    :class="{ 'quran-toolbar--hidden': !isUiVisible }"
  >
    ...
    <div v-if="showSettings" class="toolbar-right">
      ...
      >
        <!-- Translation Icon: Show when currently in 'mushaf' mode to suggest switching to translation -->
        <svg
          v-if="readingMode === 'mushaf'"
          xmlns="http://www.w3.org/2000/svg"
          width="18"
          height="18"
          viewBox="0 0 24 24"
        ...
        <!-- Mushaf Icon: Show when currently in 'translation' mode to suggest switching to mushaf -->
        <svg
          v-else
          xmlns="http://www.w3.org/2000/svg"
          width="18"
